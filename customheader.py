...
def addheader(sp):
	...
	nt=sp.new_tag("header",**{'class':'custom_opengenus_offline_header_class'},id="custom_opengenus_offline_header_tagheader")
	sp.head.insert(1,nt)
	tag=sp.find("header",{"id":"custom_opengenus_offline_header_tagheader"})
